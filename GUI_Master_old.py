...
#
lbl = tk.Label(root, text="Heart Disease  Prediction and Prevention System  ", font=('Georgia', 30,' bold '), height=1, width=55,bg="black",fg="white")
lbl.place(x=0, y=10)
...
#    global fn
    ...
    if fn!="":
        ...
        model = load_model('arrhythmia_model.h5')
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='E:/Kirti/Heart Disease Detection/Dataset', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
