...
path1 = 'E:/Kirti/Heart Disease Detection/Dataset/test_set/0'    #path of folder of images    
path2 = 'E:/Kirti/Heart Disease Detection/Dataset/test/0'  #path of folder to save images    
